                    ...
                    return (
                        <Card key={dia.toISOString()} className="h-24 p-1 overflow-hidden">
                            <div className="flex items-start justify-between">
                                ...
                                <Badge variant={getBadgeVariant(nivelLotacao)} className={"rounded-full px-2 py-1"}>{nivelLotacao}</Badge>
                            </div>
                                        ...
                                        <div className="space-y-1 mt-2">
                                            {alocacoes.map((alocacao) => (
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        className="font-medium">{obterNomePosto(alocacao.postoId)}</div>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
